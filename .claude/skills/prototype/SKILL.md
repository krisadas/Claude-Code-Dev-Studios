---
name: prototype
description: "Rapid prototyping workflow. Skips normal standards to quickly validate a feature or technical concept. Produces throwaway code and a structured prototype report."
...
2. **Read CLAUDE.md** for project context and the current tech stack. Understand
   what language and frameworks are in use so the prototype is built with
   compatible tooling.
...
- Usability observation: [specific — "form submission felt slow at 800ms" not "felt bad"]
